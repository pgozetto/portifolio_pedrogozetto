...
import { ArrowRight, ArrowUpRight, Mail, MoveRight, Sparkles } from 'lucide-react';
  ...
  return <main>
    <section className="hero" id="inicio">
      <nav className="nav nav-wide">
        ...
        <a className="nav-cta" href="#contato">Vamos criar <ArrowUpRight size={15} /></a>
      </nav>
    ...
    <footer id="contato"><div className="footer-orb" /><div className="shell footer-content"><p className="eyebrow"><span /> Próximo projeto</p><h2>Tem uma boa ideia?<br /><em>Vamos dar forma a ela.</em></h2><a className="footer-email" href="mailto:pedro@gozetto.com.br">pedro@gozetto.com.br <ArrowUpRight /></a><div className="footer-bottom"><p>© 2026 PEDRO GOZETTO</p><div><a href="mailto:pedro@gozetto.com.br"><Mail size={17} /> E-mail</a></div></div></div></footer>
  </main>;
}
